...
RunService.RenderStepped:Connect(function()
    ...
    for player, data in pairs(ESPObjects) do
        ...
        if onScreen then
            ...
            data.Distance.Visible = SHOW_DISTANCE
        else
            data.Name.Visible = false
            data.Distance.Visible = false
        end
...
local function CreateUI()
    ...
    SkeletonToggle.Size = UDim2.new(1,-20,0,30)
    SkeletonToggle.Position = UDim2.new(0,10,0,160)
    SkeletonToggle.Text = "Toggle Skeleton ESP"
    SkeletonToggle.TextColor3 = Color3.fromRGB(255,255,255)
    SkeletonToggle.BackgroundColor3 = Color3.fromRGB(80,80,80)
    SkeletonToggle.Parent = Frame

    local DistanceToggle = Instance.new("TextButton")
    DistanceToggle.Size = UDim2.new(1,-20,0,30)
    DistanceToggle.Position = UDim2.new(0,10,0,200)
